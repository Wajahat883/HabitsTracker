...
export default function HabitList({ showArchived = false, onArchive, onDelete }) {
  ...
  return (
    <div className="space-y-3">
      ...
      <ul className="space-y-2" role="list" aria-label="Habits list">
        {filtered.map(h => (
          <li key={h._id} className="bg-slate-800 rounded-lg p-3 flex items-center justify-between border border-slate-700" role="listitem">
            <div>
